...
const Contact = () => {
  ...
  const technicalSkills = {
    "Web Development": ["JavaScript (ES6+)", "TypeScript", "React", "Next.js", "Node.js", "Express.js", "Angular", "Vue.js", "Redux", "GraphQL", "REST APIs", "TailwindCSS", "Material UI", "Bootstrap", "SASS"],
    "Databases & Data Engineering": ["PostgreSQL", "MySQL", "MS SQL Server", "MongoDB", "Snowflake", "Amazon Redshift", "BigQuery", "Apache Kafka", "Apache Airflow", "AWS Glue", "DBT"],
    "Cloud & DevOps": ["AWS (EC2, S3, RDS, Lambda)", "Google Cloud", "Azure", "Docker", "Kubernetes", "Jenkins", "CircleCI", "Travis CI"],
    "Reporting & Analytics": ["Power BI", "Tableau", "SSRS", "Kibana", "Qlik", "Sisense"],
    "APIs & Integration": ["GraphQL", "REST APIs"],
    "Tools & Version Control": ["Git", "GitHub", "GitLab", "Bitbucket"],
    "Languages": ["JavaScript", "Python", "Java", "C#", "SQL", "T-SQL", "HTML/CSS", "PHP", "Ruby"]
  };
              ...
              <Card className="bg-terminal-background border-terminal-accent/30">
                ...
                <CardContent className="prose prose-invert max-w-none">
                  <p className="text-terminal-foreground/90">
                    Full Stack Software Engineer building scalable, high-performance web and data platforms.
                    At Mandiant (acquired by Google/Alphabet), I developed secure dashboards and automated data
                    pipelines that improved client onboarding and threat analytics reporting. Skilled in React,
                    Node.js, Python, and cloud platforms like AWS and GCP, with a focus on performance, system
                    reliability, and real-time data integration. I thrive in cross-functional teams and bring a
                    product-focused mindset to both frontend and backend development.
                  </p>
                </CardContent>
              </Card>
